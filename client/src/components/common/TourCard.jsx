...
const TourCard = ({ tour }) => {
  const { id, name, location, duration, price, imageUrl, rating = "4.5", reviewCount = 0, description, featured = false } = tour;
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden group">
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        {/* Featured badge */}
        {featured && <div className="absolute top-3 left-3 bg-primary text-white text-xs font-semibold px-2.5 py-1 rounded-full">Nổi bật</div>}
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <span className="text-xs text-gray-500 block">/người</span>
          </div>

          <Link to={`/tours/${id}`} className="bg-primary hover:bg-primary/90 text-white font-medium text-sm py-2 px-4 rounded">
            Chi tiết
          </Link>
        </div>
      </div>
