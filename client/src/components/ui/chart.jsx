        ...
        {payload.map((item, index) => {
          ...
          return (
            <div key={item.dataKey} className={cn("flex w-full flex-wrap items-stretch gap-2 [&>svg]:h-2.5 [&>svg]:w-2.5 [&>svg]:text-muted-foreground", indicator === "dot" && "items-center")}>
              {!hideIndicator && indicator === "dot" && <span className="h-2.5 w-2.5 rounded-full" style={{ backgroundColor: indicatorColor }} />}
              {!hideIndicator && indicator === "line" && <span className="h-full w-0.5" style={{ backgroundColor: indicatorColor }} />}
              {!hideIndicator && indicator === "dashed" && <span className="h-full w-0.5 border-l-2 border-dashed" style={{ borderColor: indicatorColor }} />}
