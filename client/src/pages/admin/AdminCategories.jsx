...
//         variant: "destructive",
//         title: "Lỗi",
//         description: "Không thể tải danh sách loại tour. Vui lòng thử lại sau.",
//       });
//     } finally {
//       setIsLoading(false);
//     }
...
//         variant: "destructive",
//         title: "Lỗi",
//         description: "Không thể lưu loại tour. Vui lòng thử lại sau.",
//       });
//     } finally {
//       setIsLoading(false);
...
//           variant: "destructive",
//           title: "Lỗi",
//           description: "Không thể xóa loại tour. Vui lòng thử lại sau.",
//         });
//       } finally {
//         setIsLoading(false);
//       }
...
//     (category.tourTypeName || "").toLowerCase().includes(searchTerm.toLowerCase())
//   );
...
//                   <td className="py-4 px-4 text-sm text-gray-900">{category.tourTypeId}</td>
...
//                         size="icon"
//                         className="h-8 w-8"
//                         onClick={() => handleDelete(category.tourTypeId)}
//                         disabled={isLoading}
//                       >
  ...
  return (
    <div className="p-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden p-6 text-center text-sm text-gray-500">
          Chưa có loại tour nào. Hãy thêm loại tour mới!
        </div>
      ) : filteredCategories.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm overflow-hidden p-6 text-center text-sm text-gray-500">
          Không tìm thấy loại tour khớp với từ khóa.
        </div>
      ) : (
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          <table className="w-full">
